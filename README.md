...
- lilDavid, for creating the AP implementation this is based on, writing most of the autotracking code, providing the overview map image, adding the broadcast view, and helping with some location placements and other things related to the pack
